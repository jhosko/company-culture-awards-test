    ...
    <Layout>
      <section className="pageHero">
        <div className="container narrow">
          <div className="eyebrow">Program timeline</div>
          <h1>Key dates.</h1>
          <p>Mark your calendar for voting, publication, and the awards celebration.</p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container narrow">
          <div className="timeline">
            {dates.map(([date, title, body]) => (
              <article className="timelineItem" key={`${date}-${title}`}>
          ...
          <div className="centerAction timelineAction">
